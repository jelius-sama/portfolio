...
echo "Developing with ADMIN_PASSWORD & NEXT_PUBLIC_IP_LOCATION_PROVIDER_API_KEY"
ADMIN_PASSWORD="$ADMIN_PASSWORD" NEXT_PUBLIC_IP_LOCATION_PROVIDER_API_KEY="$NEXT_PUBLIC_IP_LOCATION_PROVIDER_API_KEY" sst dev
