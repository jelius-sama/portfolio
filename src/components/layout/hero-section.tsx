...
export default function HeroSection() {
    ...
    return (
        <section id='hero' className="min-h-screen w-full items-center flex flex-col md:flex-row justify-center gap-x-20 relative">
            ...
            <Button className='absolute right-[16px] bottom-[16px] rounded-full h-10 w-10 p-2' variant={'outline'} onClick={() => scrollToSection('about')} aria-label='Scroll to about section'><ChevronDownIcon /></Button>
        </section>
    );
}
