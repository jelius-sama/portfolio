...
export default function AboutSection() {
  ...
  return (
    <section
      id="about"
      className="w-full min-h-screen relative pb-[calc(64px_+_16px)] pt-[64px]"
    >
      {" "}
      {/* "pb-[calc(10px_+_16px_+_16px_+_16px_+10px)]" */}
      ...
      <Card className="w-full sm:w-[50%] xl:w-[350px]">
        <CardContent className="flex w-full h-full items-center flex-col flex-nowrap justify-center p-0 py-2">
          ...
          <Title
            ...
            varient="subtitle"
            fullWidth={true}
            className={`!text-[1rem] md:!text-xl my-2 text-center`}
          >
            Experience
          </Title>
          ...
          <Title
            varient="info"
            className="!font-medium !text-lg !text-ellipsis !line-clamp-1 text-center"
            fullWidth={true}
          >
            {String(new Date().getFullYear() - About.experience[0].timespan) +
              "+ years"}
          </Title>
          <Title
            varient="info"
            ...
            fullWidth={true}
          >
            {String(About.experience[0].field)}
          </Title>
        </CardContent>
      </Card>
...
function SpeechAndQuote() {
  return (
    <React.Fragment>
      <p className="mt-5 leading-8 text-justify">{About.speech}</p>

      <p className="mt-5 italic font-semibold text-justify">
        &quot;{About.quote}&quot; - {About.firstName}
      </p>
    </React.Fragment>
  );
}
